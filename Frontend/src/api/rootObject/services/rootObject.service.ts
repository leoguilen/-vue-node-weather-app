...
export class RootObjectService implements IRootObjectService {
    ...
    public constructor () {
      this._basePlacesUrl = new URL('http://www.geonames.org/childrenJSON?geonameId=3469034&callback=listPlaces&style=long&noCacheIE=1585428772700');
    ...
    async GetListRootObjectModelCityAsync (stateGeoId: string): Promise<IRootObjectModel[]> {
    ...
    async GetRootObjectWeatherAsync (placeName: string): Promise<IRootObjectWeatherModel> {
